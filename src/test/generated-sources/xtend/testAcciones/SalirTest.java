...
public class SalirTest {
  ...
  public void setUp() {
    ...
    Usar _usar = new Usar(1, this.llave, this.moverA4);
    this.usarLlave = _usar;
    Usar _usar_1 = new Usar(2, this.piedra, this.agarrarLlave);
    this.usarPiedra = _usar_1;
    Usar _usar_2 = new Usar(3, this.pala, this.moverA9);
    this.usarPala = _usar_2;
    Usar _usar_3 = new Usar(4, this.manivela, this.moverA5);
    this.usarManivela = _usar_3;
    Usar _usar_4 = new Usar(5, this.madera, this.moverA8);
    ...
    Jugador _jugador = new Jugador(1, "Jugador", this.hab8);
    this.jugador = _jugador;
    Jugador _jugador_1 = new Jugador(2, "Jugador2", this.hab8);
  ...
  public void setJuego2(final Juego juego2) {
    this.juego2 = juego2;
  }
  ...
  public void setJugador2(final Jugador jugador2) {
